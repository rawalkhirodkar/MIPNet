...
from core.train_general import train_lambda_0123
from core.validate_general import validate_lambda_0123
...
def main():
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        # # # train for one epoch
        print('training on lambda for 0, 1, 2, 3')
        train_lambda_0123(cfg, train_loader, model, criterion_lambda, criterion, optimizer, epoch,
              final_output_dir, tb_log_dir, writer_dict, print_prefix='lambda_0123')

        if epoch % cfg.EPOCH_EVAL_FREQ == 0:            
            validate_lambda_0123(cfg, valid_loader, valid_dataset, model, criterion,
                     final_output_dir, tb_log_dir, writer_dict, epoch=epoch, print_prefix='lambda_0123')
