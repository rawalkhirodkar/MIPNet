...
# # # # # # # # # # # -----------------------------------------------------------
 CUDA_VISIBLE_DEVICES=0,1,2 python tools/lambda_general/train_lambda_real_0123.py \
     ...
     DATASET.TRAIN_DATASET 'coco_lambda_0123' \
     ...
     DATASET.TRAIN_DATASET_TYPE 'coco_lambda_0123' \
